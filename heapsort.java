...
for sorting...
BEST CASE SCENARIO: Array in max to min order

WORST CASE SCENARIO: Array already sorted! (wowww)
nlog(n) run time and n memory spaceage
 */
...
_heap.set( pos1, _heap.set( pos2, _heap.get(pos1) ) );	
    ...
    /*******************************************
HEAP SORT WOW OMG LOOK IT SORTS
     */
